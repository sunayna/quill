...
```
report-remark-review/
├── ARCHITECTURE.md                    ← long-term platform roadmap (read this first)
├── rubric/
│   └── report_remark_rubric.json      ← source of truth. All rules, severities,
...
│   ├── Report_Remark_Teacher_Checklist.docx  ← formatted, printable version
...
2. **AI check** — in a fresh chat with any capable LLM: paste `prompts/system_prompt.md`, upload `rubric/report_remark_rubric.json`, upload that batch's remarks spreadsheet.
